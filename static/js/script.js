document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchDigitosResults() {
        ...
        const tableBody = document.getElementById('QuinaResults').getElementsByTagName('tbody')[0];
    ...
    function renderResults(results) {
        ...
        if (!resultsInfoDiv) {
            ...
            const tableContainer = document.getElementById('QuinaResults').parentNode;
            tableContainer.insertBefore(infoDiv, document.getElementById('QuinaResults'));
        } else {
...
// Funções para download
 function downloadCSV() {
    ...
    link.download = 'analise_digitos_quina.xls';
    link.click();
}
...
function downloadJSON() {
    ...
    const link = document.createElement("a");
    link.href = URL.createObjectURL(blob);
    link.download = 'analise_digitos_quina.html';
    link.click();
}    
    function downloadTXT() {
        ...
        downloadFile(txtContent, 'analise_digitos_quina.txt', 'text/plain');
    }
